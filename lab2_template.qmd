...
ggplot(vulnerable_tracts_county_centers)+
  geom_sf()+
  theme_void()
plot(vulnerable_tracts_county_centers)
...
View(underserved_tracts_out_of_vulnerable_which_are_more_than_15_miles)
underserved_tracts_out_of_vulnerable_which_are_more_than_15_miles <- rename(underserved_tracts_out_of_vulnerable_which_are_more_than_15_miles, county_names = NAMELSADCO)
View(underserved_tracts_out_of_vulnerable_which_are_more_than_15_miles)
...
```{r}
ggplot(data = underserved_tracts_out_of_vulnerable_which_are_more_than_15_miles, aes(x = dist_to_nearest, y = county_names)) +
