...
The picture below shows the centers of vulnerable tracts. Starting from here, I calculated the distance to the nearest hospital from each vulnerable tract. 
